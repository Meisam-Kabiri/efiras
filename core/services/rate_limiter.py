...
class SimpleMemoryRateLimiter:
    ...
    def check_and_increment(self, request):
        ...
        with self.lock:
            ...
            print(
                f"🔍 Debug - Current counts: minute={minute_count}, hour={hour_count}, day={day_count}"
            )
            print(
                f"🔍 Debug - Limits: minute={self.LIMITS['minute']}, hour={self.LIMITS['hour']}, day={self.LIMITS['day']}"
            )
