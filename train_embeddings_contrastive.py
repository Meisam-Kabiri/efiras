...
def main():
    ...
    # Load data
    data_file = "data_processed/Lux_cssf18_698eng_chunked_blocks.json"
    data_file2 = "data_processed/Basel_III_chunked_blocks.json"
    print(f"\n📂 Loading: {data_file}")
    ...
    positive_pairs, negative_pairs = builder.create_contrastive_positive_negative_pairs(chunks)
    positive_pairs2, negative_pairs2 = builder.create_contrastive_positive_negative_pairs(chunks2)
    all_pairs = positive_pairs + negative_pairs
    all_pairs += positive_pairs2 + negative_pairs2

    print(f"✅ Created {len(positive_pairs)} positive + {len(negative_pairs)} negative pairs")
