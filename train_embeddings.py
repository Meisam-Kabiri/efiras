...
def main():
    ...
    if choice in ["1", "3"]:
        ...
        processed_files = [
            # "data_processed/Basel_III_chunked_blocks.json",
            "data_processed/Lux_cssf18_698eng_chunked_blocks.json"
        ]
        ...
        for file_path in processed_files:
            if Path(file_path).exists():
                ...
                dataset = builder.generate_fixed_size_mnrl_batches(chunks, batch_size=8)
    ...
    if choice in ["2", "3"]:
        ...
        fixed_batch_files = list(Path("training_data").glob("mnrl_fixed_batch_dataset_*.json"))
